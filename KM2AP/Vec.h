...
class Vec {
  ...
  public:
    ...
    inline void setVec12(double x, double y, double z)
    {
    ...
    inline static Vec getVec12(double x, double y, double z)
    {
       x = 1.0 + (x + 8.0) / (16.0);
       y = 1.0 + (y + 8.0) / (16.0);
       z = 1.0 + (z + 8.0) / (16.0);

       if(!(1.0 < x && x < 2.0)) cout << "warning x" << endl;
       if(!(1.0 < y && y < 2.0)) cout << "warning y" << endl;
       if(!(1.0 < z && z < 2.0)) cout << "warning z" << endl;
